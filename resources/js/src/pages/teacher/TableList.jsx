...
function TableList() {
    ...
    const GetList = async (url = "/api/teacher/list") => {
        setLoading(true);
    ...
    const confirmDelete = async () => {
        const res = await actions.Delete(`/api/teacher/${idSelected}`);
    ...
    return (
        <Fragment>
            <BreadCrumb
                ...
                active_label="Table"
            />
            <Modal id="delete-guru" title="Konfirmasi">
            ...
            <div className="card">
                <div className="card-header">
                    <div className="row">
                        <div className="col-md-8">Daftar Guru</div>
                        <div className="col-md-4">
                            {myAccess[0] &&
                                myAccess[0].indexOf("create") !== -1 && (
                                    <Link
                                        to="/dashboard/guru?action=add"
                                        style={{ float: "right" }}
                                                    ...
                                                    {myAccess[0] &&
                                                        myAccess[0].indexOf(
                                                            ...
                                                            <Link
                                                                ...
                                                                to={`/dashboard/guru?action=edit&id=${item.id}`}
                                                            >
                                                                Ubah
                                                            </Link>
                                                        )}{" "}
