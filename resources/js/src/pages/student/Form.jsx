...
function Form(props) {
    const { field, onChange, onSubmit, errors } = props;
    ...
    return (
        <React.Fragment>
            <div className="row g-2">
                <div className="col-md">
                    <FormItem
                        ...
                        errorMsg={errors && errors["nis"] && errors["nis"][0]}
                    />
                </div>
                <div className="col-md">
                    <FormItem
                ...
                <div className="row g-2">
                    <div className="col-md-6">
                        <FormItem
                            ...
                            value={field.guardian_parent}
                            onChange={(e) =>
                                onChange("guardian_parent", e.target.value)
                            }
                            errorMsg={
                                errors &&
                                errors["guardian_parent"] &&
                                errors["guardian_parent"][0]
                            }
                        />
                    </div>
                </div>
            ...
            <div className="mt-4">
                <Link to="/dashboard/siswa" className="btn btn-danger">
                    <svg
